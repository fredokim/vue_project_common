        ...
        >
            ...
            >
                ...
                <div
                    ...
                    @click="addTag(index)"
                >
                    <span class="tags__create-tag-label" v-if="tagCreationEnabled && tag.id === 0">태그 추가</span>
                    <div
...
<script>
    export default {
        ...
        methods: {
            ...
            tagSelected(index) {
                return this.active.some(element => element.id === this.filteredList[index].id);
            },
            handleEnterKey() {
...
<style scoped>
 ...
 .tags__list-item-tag:last-child {
	 margin: 0;
}
 .tags__create-tag-label {
